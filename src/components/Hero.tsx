...
export const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-white via-purple-50/30 to-rose-50/20 dark:from-gray-900 dark:via-gray-800/50 dark:to-gray-700/20 flex items-center justify-center px-4 md:px-6 lg:px-8 relative overflow-hidden pt-20 md:pt-24 pb-8 transition-colors duration-300">
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl max-w-md w-full">
